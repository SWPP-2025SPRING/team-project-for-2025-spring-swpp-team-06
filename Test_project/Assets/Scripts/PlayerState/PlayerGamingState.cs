...
public class PlayerGamingState : IPlayerState
{
    private float timer;
    ...
    public void Enter(PlayerControl player)
    {
        ...
        {
            player.groundRotator.SetRotationMultiplier(0.5f);
        }
    }
    ...
    {
        float acceleration = player.acceleration * 0.5f;
        float maxSpeed = player.maxSpeed * 0.5f;
